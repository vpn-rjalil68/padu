...
state=Malaysia
locality=Malaysia
organization=budakgerik.tk
organizationalunit=budakgerik.tk
commonname=budakgerik.tk
email=rjvpn1968@gmail.com

# simple password minimal
wget -O /etc/pam.d/common-password "https://raw.githubusercontent.com/vpn-rjalil68/padu/main/password"
...
echo "clear" >> .profile
echo "neofetch --ascii_distro mac" >> .profile
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/vpn-rjalil68/padu/main/nginx.conf"
mkdir -p /home/vps/public_html
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/vpn-rjalil68/padu/main/vps.conf"
/etc/init.d/nginx restart

# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/vpn-rjalil68/padu/main/badvpn-udpgw64"
...
wget -O /etc/squid/squid.conf "https://raw.githubusercontent.com/vpn-rjalil68/padu/main/squid3.conf"
...
#OpenVPN
wget https://raw.githubusercontent.com/vpn-rjalil68/padu/main/vpn.sh &&  chmod +x vpn.sh && ./vpn.sh
