...
# // Make Main Directory
mkdir -p /usr/local/VPN-BUDAKGERIK/

# // Installation XRay Core
wget -q -O /usr/local/VPN-BUDAKGERIK/xray-mini "https://raw.githubusercontent.com/vpn-rjalil68/padu/main/xray-mini" 
chmod +x /usr/local/VPN-BUDAKGERIK/xray-mini
...
ExecStart=/usr/local/VPN-BUDAKGERIK/xray-mini -config /etc/xray-mini/%i.json
Restart=on-failure
...
# // Downloading Menu
wget -q -O /usr/bin/add-xray "https://raw.githubusercontent.com/vpn-rjalil68/padu/main/add-xray.sh"
wget -q -O /usr/bin/del-xray "https://raw.githubusercontent.com/vpn-rjalil68/padu/main/del-xray.sh"
wget -q -O /usr/bin/renew-xray "https://raw.githubusercontent.com/vpn-rjalil68/padu/main/renew-xray.sh"
