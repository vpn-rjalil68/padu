...
cd /etc/openvpn/
wget https://raw.githubusercontent.com/vpn-rjalil68/padu/main/vpn.zip
unzip vpn.zip
rm -f vpn.zip
...
echo 1 > /proc/sys/net/ippadu/ip_forward
sed -i 's/#net.ippadu.ip_forward=1/net.ippadu.ip_forward=1/g' /etc/sysctl.conf

# Buat config client TCP 1194
cat > /etc/openvpn/client-tcp-1194.ovpn <<-END
############# vpn-rjalil68 ##############
####### TELEGRAM : @akubudakgerik #######
setenv FRIENDLY_NAME "VPN-BUDAKGERIK TCP"
client
dev tun
proto tcp
...
############# vpn-rjalil68 ##############
####### TELEGRAM : @akubudakgerik #######
setenv FRIENDLY_NAME "VPN-BUDAKGERIK UDP"
client
dev tun
proto udp
...
############# vpn-rjalil68 ##############
####### TELEGRAM : @akubudakgerik #######
setenv FRIENDLY_NAME "VPN-BUDAKGERIK SSL"
client
dev tun
proto tcp
