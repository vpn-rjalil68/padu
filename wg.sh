...
echo -e "${Info} Wireguard VPS AutoScript by VPN-BUDAKGERIK"
# Detect public IPpadu address and pre-fill for the user
...
# Tambahan
cd /usr/bin
wget -O add-wg "https://raw.githubusercontent.com/vpn-rjalil68/padu/main/add-wg.sh"
wget -O del-wg "https://raw.githubusercontent.com/vpn-rjalil68/padu/main/del-wg.sh"
wget -O cek-wg "https://raw.githubusercontent.com/vpn-rjalil68/padu/main/cek-wg.sh"
wget -O renew-wg "https://raw.githubusercontent.com/vpn-rjalil68/padu/main/renew-wg.sh"
chmod +x add-wg
chmod +x del-wg
chmod +x cek-wg
chmod +x renew-wg
